...
const { dogfoodingPluginInstances, dogfoodingThemeInstances } = require('./_dogfooding/dogfooding.config')
...
const allDocHomesPaths = ['/docs/', '/docs/next/', ...versions.slice(1).map((version) => `/docs/${version}/`)]
